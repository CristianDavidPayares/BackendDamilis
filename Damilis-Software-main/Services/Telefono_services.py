...
def servListTelefono():
    ...
    telefonos_l = []
    for t in data:
        telefonos_l.append(Telefono(t[0], t[1], t[2], t[3]).to_dic())

    c.close()
    return telefonos_l


def addTelefono(user_id, telefono):
...
def servListTelefonoByUser(user_id):
